...
class Board:
    ...
    def draw_board(self):
        ...
        """
        # Drawing the grid lines and tiles
        for i in range(9):
            for j in range(9):
...
# Class representing a single Sudoku tile
class Tile:
    def __init__(
        self,
        value,
...
def main():
    ...
    pygame.display.set_caption("Sudoku Solving Algorithm - By GeorgiPapazov | github.com/ItsGeorgiPapazov")
